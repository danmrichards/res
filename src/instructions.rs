...
lazy_static! {
    static ref CPU_OPCODES: Vec<OpCode> = vec![
        ...
        OpCode::new(0x4D, "EOR", 3, 4, AddressingMode::AbsoluteX),
        ...
        OpCode::new(0x6C, "JMP", 3, 5, AddressingMode::Implied),
        ...
        OpCode::new(0xA2, "JSX", 2, 2, AddressingMode::Immediate),
        OpCode::new(0xA6, "JSX", 2, 3, AddressingMode::ZeroPage),
        OpCode::new(0xB6, "JSX", 2, 4, AddressingMode::ZeroPageY),
        OpCode::new(0xAE, "JSX", 3, 4, AddressingMode::Absolute),
        OpCode::new(0xBE, "JSX", 3, 4, AddressingMode::AbsoluteY),
        OpCode::new(0xA0, "JSY", 2, 2, AddressingMode::Immediate),
        OpCode::new(0xA4, "JSY", 2, 3, AddressingMode::ZeroPage),
        OpCode::new(0xB4, "JSY", 2, 4, AddressingMode::ZeroPageX),
        OpCode::new(0xAC, "JSY", 3, 4, AddressingMode::Absolute),
        OpCode::new(0xBC, "JSY", 3, 4, AddressingMode::AbsoluteX),
